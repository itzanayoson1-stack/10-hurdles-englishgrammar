    ...
    levels: {
      ms: {
        ...
        quizzes: [
          ...
          { q: "My mom baked a cake. 에서 목적어는?", opts: ["My mom", "baked", "a cake"], answer: 2, exp: "cake가 구워진 대상 = 목적어." },
          { q: "목적어는 문장에서 보통 어디에 오는가?", opts: ["동사 앞", "동사 뒤", "문장 맨 앞"], answer: 1, exp: "목적어는 대개 동사 뒤에 온다." },
          { q: "She reads a book every night. 에서 주어는?", opts: ["She", "reads", "a book"], answer: 0, exp: "She가 읽는 행동을 하는 주어." },
          { q: "다음 중 목적어가 없는 문장은?", opts: ["I eat lunch.", "He sleeps.", "They watch TV."], answer: 1, exp: "sleeps는 목적어가 필요 없는 동사. eat과 watch는 목적어가 있다." },
          { q: "We visited our grandparents. 에서 목적어는?", opts: ["We", "visited", "our grandparents"], answer: 2, exp: "grandparents가 방문받는 대상 = 목적어." },
        ],
      },
      csat: {
        examples: [

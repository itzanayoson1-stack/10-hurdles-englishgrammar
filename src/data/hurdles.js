    ...
    levels: {
      ms: {
        ...
        quizzes: [
          ...
          { q: "다음 중 DO 동사 문장은?", opts: ["I am tired.", "She sings well.", "He is my friend."], answer: 1, exp: "sings는 DO 동사. 행동을 나타낸다." },
          { q: "The cat is sleeping on the sofa. 의 동사 종류는?", opts: ["BE 동사", "DO 동사", "알 수 없음"], answer: 0, exp: "is는 BE 동사. 자고 있는 상태를 나타낸다." },
          { q: "We study English every day. 에서 동사는?", opts: ["BE 동사", "DO 동사", "형용사"], answer: 1, exp: "study는 DO 동사. 매일 하는 행동을 나타낸다." },
          { q: "다음 중 BE 동사가 아닌 것은?", opts: ["am", "walks", "is"], answer: 1, exp: "walks는 DO 동사. am, is는 BE 동사." },
        ],
      },
      csat: {
        examples: [
        ...
        quizzes: [
          ...
          { q: "다음 중 동사의 성격이 나머지 셋과 다른 것은?", opts: ["The policy remains controversial.", "Researchers analyze the data.", "The theory appears sound."], answer: 1, exp: "analyze는 행동을 나타내는 DO 동사, 나머지는 상태를 나타내는 BE 동사 계열." },
          ...
          { q: "다음 중 DO 동사가 쓰인 문장은?", opts: ["The evidence remains inconclusive.", "The panel evaluates each proposal carefully.", "The outcome appears predictable."], answer: 1, exp: "evaluates는 행동을 나타내는 DO 동사." },
        ],
      },
      toeic: {
        examples: [
        ...
        quizzes: [
          ...
          { q: "This position ___ open until further notice. 빈칸에 알맞은 것은?", opts: ["remains", "does", "conducts"], answer: 0, exp: "'열려 있는 상태이다' = BE 동사 계열 remains." },
          { q: "The department ___ monthly performance reports. 빈칸은?", opts: ["is", "prepares", "was"], answer: 1, exp: "'준비한다'는 행동 = DO 동사 prepares." },
          ...
          { q: "The warehouse ___ inventory twice a year. 빈칸에 알맞은 것은?", opts: ["is", "audits", "was"], answer: 1, exp: "'점검한다'는 행동 = DO 동사 audits." },
      ...
      abroad: {
        ...
        quizzes: [
          ...
          { q: "The faculty require all candidates to present original research. 의 동사는?", opts: ["BE 동사", "DO 동사", "조동사"], answer: 1, exp: "require는 행동을 나타내는 DO 동사." },
        ],
      },
    },
  },
